...
class FilterPopUp(Config):
    ...
    def __init__(self, master, pd, filters):
        ...
        self.filt_no_cbutton.grid(row=3, 
                                  column=0, 
                                  columnspan=3, 
                                  padx=pd, 
                                  sticky='w')
        ...
        self.filt_no_entry = ttk.Entry(self.filt_popup,
                                       width=pd*8,
                                       textvariable=self.filt_no_entry_var)
        self.filt_no_entry.insert(0, filters.current_no_cfilter)
        self.filt_no_entry.grid(row=4, 
                                column=0, 
                                columnspan=3, 
                                padx=pd, 
                                pady=pd, 
        ...
        self.filt_only_cbutton.grid(row=5, 
                                    column=0, 
                                    columnspan=3, 
                                    padx=pd, 
                                    sticky='w')
        ...
        self.filt_only_entry.grid(row=6, 
                                  column=0, 
                                  columnspan=3, 
                                  padx=pd, 
                                  pady=pd, 
        ...
        self.filt_omit_cbutton.grid(row=7, 
                                    column=0, 
                                    columnspan=3, 
                                    padx=pd, 
                                    sticky='w')
