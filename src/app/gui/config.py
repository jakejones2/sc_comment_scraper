...
class Config:
    ...
    def __init__(self):
        ...
        self.style.configure("TFrame", background=self.background_colour)
        self.style.configure("start.TFrame", background=self.background_colour)
        ...
        self.style.configure(
            "TEntry", foreground="black", font=(self.font_light, "9")
        )
        self.style.configure(
            "internal.TButton",
            foreground=self.text_colour,
        ...
        self.style.map("internal.TButton", foreground=[("hover", "black")])
        self.style.configure(
            "internal2.TButton",
            foreground=self.text_colour,
            background=self.tab_colour,
        ...
        self.style.map("internal2.TButton", foreground=[("hover", "black")])
        self.style.configure("inner.TFrame", background=self.tab_colour)
        self.style.configure(
            "sub.TLabel",
            foreground=self.text_colour,
            background=self.tab_colour,
