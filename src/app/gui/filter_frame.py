...
class FilterFrame(Config):
    ...
    def __init__(self, set_frame, pd, master, filters):
        ...
        self.filt_frame.grid(column=0, 
                             row=4, 
                             columnspan=5, 
                             sticky='w', 
                             padx=0)
        self.filt_heading_label = ttk.Label(self.filt_frame,
                                            text='Filters',
                                            style='sub2.TLabel',
                                            padding=[pd, pd, pd, pd])
        ...
        self.filt_n_cbutton = ttk.Checkbutton(self.filt_frame, 
                                              text=' None',
        ...
        self.filt_je_cbutton = ttk.Checkbutton(self.filt_frame, 
                                               text=' Just emojis',
                                               style='filters.TCheckbutton',
        ...
        self.filt_ne_cbutton = ttk.Checkbutton(self.filt_frame, 
                                              text=' No emojis',
                                              style='filters.TCheckbutton',
        ...
        self.filt_nt_cbutton = ttk.Checkbutton(self.filt_frame, 
                                              text=' No user tags',
                                              style='filters.TCheckbutton',
                                              variable=self.filt_nt_var,
                                              command=nt_cbutton)
        self.filt_nt_cbutton.grid(row=2, column=0, padx=pd*3, pady=pd, sticky='w')
        ...
        self.filt_nr_cbutton = ttk.Checkbutton(self.filt_frame, 
                                               text=' No replies',
                                               style='filters.TCheckbutton',
                                               variable=self.filt_nr_var,
                                               command=nr_cbutton)
        self.filt_nr_cbutton.grid(row=2, column=1, padx=pd*3, pady=pd, sticky='w')
        ...
        self.filt_ns_cbutton = ttk.Checkbutton(self.filt_frame, 
                                              text=' No social',
                                              style='filters.TCheckbutton',
                                              variable=self.filt_ns_var,
                                              command=ns_cbutton)
        self.filt_ns_cbutton.grid(row=2, column=2, padx=pd*3, pady=pd, sticky='w')
        self.filt_dict[6] = self.filt_ns_cbutton


        #custom filters button
        def custom_filters():    
            self.custom_filter_pop = FilterPopUp(master=master, pd=pd, filters=filters)
            
        self.custom_filter_button = ttk.Button(self.filt_frame, 
                                               text=" Custom filters ", 
                                               command=custom_filters, 
                                               style='internal2.TButton')
        self.custom_filter_button.grid(row=3, 
                                       column=0, 
                                       sticky='w', 
                                       padx=pd*2, 
                                       pady=pd*1.5)
